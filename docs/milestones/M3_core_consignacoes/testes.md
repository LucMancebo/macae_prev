...
| ---------- | -------------------------------- | --------------------------------------- | ----------------------- | ------- |
| E2E-CSN-01 | Criar consignação válida         | POST /v1/consignacoes                   | 201 + status SOLICITADA | ✅ DONE |
| E2E-CSN-02 | Servidor inexistente             | POST (servidor_id invalid)              | 400                     | ✅ DONE |
| E2E-CSN-03 | Margem insuficiente              | POST (valor > disponível)               | 400                     | ✅ DONE |
| E2E-CSN-04 | Aprovar consignação              | PUT /v1/consignacoes/:id/aprovar        | 200 + APROVADA          | ✅ DONE |
| E2E-CSN-05 | Ativar desconto                  | PUT /v1/consignacoes/:id (ATIVA)        | 200 + parcelas criadas  | ✅ DONE |
| E2E-CSN-06 | Gerar parcelas corretamente      | GET /v1/consignacoes/:id/parcelas       | 200 + 12 parcelas       | ✅ DONE |
| E2E-CSN-07 | Quitar consignação               | PUT /v1/consignacoes/:id/quitar         | 200 + QUITADA           | ✅ DONE |
| E2E-CSN-08 | Cancelar consignação             | PUT /v1/consignacoes/:id/cancelar       | 200 + CANCELADA         | ✅ DONE |
| E2E-CSN-09 | CET calculado corretamente       | POST (verificar cet_percentual)         | CET > taxa              | ✅ DONE |
| E2E-CSN-10 | Portabilidade para novo contrato | POST /v1/consignacoes/:id/portabilidade | 201 + PORTADA           | ✅ DONE |

### Fluxos de Erro

| ID          | Cenário                      | Ações                                      | Esperado | Status     |
| ----------- | ---------------------------- | ------------------------------------------ | -------- | ---------- |
| E2E-CSN-E01 | Transição de estado inválida | PUT /v1/consignacoes/:id (QUITADA → ATIVA) | 409      | ✅ DONE    |
| E2E-CSN-E02 | Sem autorização              | POST /v1/consignacoes (sem token)          | 401      | ✅ DONE    |
| E2E-CSN-E03 | Perfil não Admin             | PUT /v1/consignacoes/:id/aprovar (USER)    | 403      | ⚠️ PARTIAL |
...
**Status**: 🟢 M3 Completa (M3.1 + M3.2 + M3.3) — 100+ testes passando
...
- M2 E2E: 16 tests ✅
- Servidores: 5 tests ✅
- Consignatárias: 8 tests ✅
- Produtos: 6 tests ✅
- Margens: 8 tests ✅
- Consignações: 10 tests ✅

**TOTAL: 118 testes passando com exit code 0** ✅
