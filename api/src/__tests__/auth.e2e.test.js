...
describe('Auth Module — E2E Tests', () => {
    ...
    describe('POST /v1/auth/login', () => {
        it('should login successfully with correct credentials', async () => {
            ...
            const usuarioTeste = await database_1.prisma.usuario.create({
                data: {
                    nome: 'Teste Login OK',
                    email,
                    senha_hash: await bcryptjs_1.default.hash('senha_correta', 10),
                    perfil_id: perfil.id,
                    status: 'ATIVO',
                    aceitou_termos: true
                }
        ...
        it('should return 401 with wrong password', async () => {
            ...
            const usuarioAtualizado = await database_1.prisma.usuario.findUnique({
        ...
        it('should return 400 if email or password is missing', async () => {
            ...
            let response = await (0, supertest_1.default)(app.server)
                .post('/v1/auth/login')
                .send({
                senha: 'senha_correta'
            });
            ...
            response = await (0, supertest_1.default)(app.server)
                .post('/v1/auth/login')
                .send({
                email: 'test@test.com'
            });
    ...
    describe('GET /v1/auth/me', () => {
        it('should return user info with valid JWT', async () => {
            ...
            const loginResponse = await (0, supertest_1.default)(app.server)
                .post('/v1/auth/login')
                .send({
                email,
                senha: 'senha_correta'
        ...
        it('should return 401 without JWT', async () => {
            // Act
            const response = await (0, supertest_1.default)(app.server).get('/v1/auth/me');
            // Assert
            expect(response.status).toBe(401);
        });
    });
