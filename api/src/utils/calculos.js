...
class CalculosService {
     ...
     */
    static calcularCET(taxa_mensal_percentual, custos_adicionais_percentual = 0) {
     ...
     */
    static calcularParcelas(valor_principal, taxa_mensal_percentual, quantidade_parcelas) {
     ...
     */
    static calcularDisponibilidadeMaragem(valor_limite, valor_utilizado) {
     ...
     */
    static calcularPercentualUtilizacao(valor_limite, valor_utilizado) {
        if (valor_limite <= 0) {
            return 0;
        }
