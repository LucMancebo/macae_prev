...
describe('CalculosService — Unit Tests', () => {
    describe('calcularCET', () => {
        ...
        it('should calculate CET for maximum allowed rate (30%)', () => {
            const cet = calculos_1.CalculosService.calcularCET(30, 0);
    ...
    describe('calcularParcelas', () => {
        it('should calculate monthly payment for R$ 10,000 at 1.5% for 60 months', () => {
            const resultado = calculos_1.CalculosService.calcularParcelas(10000, 1.5, 60);
        ...
        it('should calculate parcelas at 0% interest (no fees)', () => {
            const resultado = calculos_1.CalculosService.calcularParcelas(10000, 0, 60);
        ...
        it('should calculate for single payment (1 month)', () => {
            const resultado = calculos_1.CalculosService.calcularParcelas(10000, 1.5, 1);
        ...
        it('should throw error for invalid principal', () => {
            expect(() => calculos_1.CalculosService.calcularParcelas(0, 1.5, 60)).toThrow();
            expect(() => calculos_1.CalculosService.calcularParcelas(-5000, 1.5, 60)).toThrow();
        });
        it('should throw error for invalid quantity', () => {
            expect(() => calculos_1.CalculosService.calcularParcelas(10000, 1.5, 0)).toThrow();
            expect(() => calculos_1.CalculosService.calcularParcelas(10000, 1.5, 60.5)).toThrow();
        });
        ...
        it('should calculate different scenarios correctly', () => {
            ...
            const cenario1 = calculos_1.CalculosService.calcularParcelas(5000, 2, 36);
            ...
            const cenario2 = calculos_1.CalculosService.calcularParcelas(15000, 1, 120);
    ...
    describe('calcularDisponibilidadeMaragem', () => {
        it('should calculate available margem (limit 5000, used 1500)', () => {
            const resultado = calculos_1.CalculosService.calcularDisponibilidadeMaragem(5000, 1500);
        ...
        it('should calculate when no margem is used', () => {
            const resultado = calculos_1.CalculosService.calcularDisponibilidadeMaragem(5000, 0);
            expect(resultado.valor_limite).toBe(5000);
        ...
        it('should calculate when margem is fully used', () => {
            const resultado = calculos_1.CalculosService.calcularDisponibilidadeMaragem(5000, 5000);
            expect(resultado.valor_limite).toBe(5000);
            expect(resultado.valor_utilizado).toBe(5000);
            expect(resultado.valor_disponivel).toBe(0);
        });
        it('should throw error when used > limit', () => {
            expect(() => calculos_1.CalculosService.calcularDisponibilidadeMaragem(5000, 5500)).toThrow();
        });
        it('should throw error for negative values', () => {
            expect(() => calculos_1.CalculosService.calcularDisponibilidadeMaragem(-5000, 1500)).toThrow();
            expect(() => calculos_1.CalculosService.calcularDisponibilidadeMaragem(5000, -1500)).toThrow();
        });
        it('should return values with 2 decimal places', () => {
            const resultado = calculos_1.CalculosService.calcularDisponibilidadeMaragem(5000.123, 1500.456);
    ...
    describe('calcularPercentualUtilizacao', () => {
        it('should calculate 50% utilization (2500/5000)', () => {
            const percentual = calculos_1.CalculosService.calcularPercentualUtilizacao(5000, 2500);
            expect(percentual).toBe(50);
        });
        it('should calculate 0% utilization (0/5000)', () => {
            const percentual = calculos_1.CalculosService.calcularPercentualUtilizacao(5000, 0);
            expect(percentual).toBe(0);
        });
        it('should calculate 100% utilization (5000/5000)', () => {
            const percentual = calculos_1.CalculosService.calcularPercentualUtilizacao(5000, 5000);
            expect(percentual).toBe(100);
        });
        it('should cap at 100% when used > limit', () => {
            const percentual = calculos_1.CalculosService.calcularPercentualUtilizacao(5000, 5500);
            expect(percentual).toBe(100);
        });
        it('should return 0% for zero limit', () => {
            const percentual = calculos_1.CalculosService.calcularPercentualUtilizacao(0, 0);
            expect(percentual).toBe(0);
        });
        it('should throw error for negative used', () => {
            expect(() => calculos_1.CalculosService.calcularPercentualUtilizacao(5000, -100)).toThrow();
        });
        it('should return values with 2 decimal places', () => {
            const percentual = calculos_1.CalculosService.calcularPercentualUtilizacao(1000, 333.33);
        ...
        it('should calculate various percentages correctly', () => {
            expect(calculos_1.CalculosService.calcularPercentualUtilizacao(10000, 1000)).toBe(10);
            expect(calculos_1.CalculosService.calcularPercentualUtilizacao(10000, 2500)).toBe(25);
            expect(calculos_1.CalculosService.calcularPercentualUtilizacao(10000, 7500)).toBe(75);
            expect(calculos_1.CalculosService.calcularPercentualUtilizacao(10000, 9999)).toBeCloseTo(100, 1);
        });
    });
});
