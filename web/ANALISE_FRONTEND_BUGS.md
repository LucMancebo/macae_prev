...
1. Consolidar abordagem: **manter estado local** (não da API)
2. Garantir inicialização em **page = 1** (1-indexed)
3. Validar cálculo de `totalPages`
4. Adicionar paginação na página de usuários
